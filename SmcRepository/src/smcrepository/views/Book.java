	...
	protected static List buildBookList() {
		...
		Book[] books = new Book[] {
				new Book(
						...
						"Chris", "Laffra"),
				new Book("Programming Ruby: A Pragmatic Programmer's Guide",
						"David", "Thomas"),
				...
				new Book("Software Development Using Eiffel", "Richard",
						"Wiener"),
				...
				new Book("BASIC Fun with Adventure Games", "Susan Drake",
						"Lipscomb"),
				...
				new Book("Cutting-Edge Java Game Programming", "Neil",
						"Bartlett"),
				new Book("The C Programming Language", "Brian W.", "Kernighan"),
				new Book("The Design and Analysis of Spatial Data Structures",
						"Hanan", "Samet"),
				...
				new Book("The Design Patterns Smalltalk Companion",
						"Sherman R.", "Alpert"),
